...
public class HostserviceError   {
  ...
  private List<Constraint> errors = new ArrayList<Constraint>();
  ...
  /**
   **/
  public HostserviceError errors(List<Constraint> errors) {
    this.errors = errors;
    return this;
  }
  ...
  @ApiModelProperty(value = "")
  @JsonProperty("errors")
  public List<Constraint> getErrors() {
    return errors;
  }
  public void setErrors(List<Constraint> errors) {
    this.errors = errors;
  }
